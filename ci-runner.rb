...
def style_check_modfied_files
  ...
  if files
    ...
    system('npm i babel babel-eslint eslint@2.7.0 eslint-plugin-jsx-a11y@latest eslint-plugin-react@4.3.0 eslint-config-airbnb gulp-eslint minimist --save-dev')
